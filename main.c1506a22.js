(this.wordle = this.wordle || {}),
  ...
  ***************************************************************************** */
    ...
    Ps.innerHTML =
      '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>Faigh am <strong>Facle</strong> le 6 tomhasan.</p>\n      <p>Feumaidh gach tomhas a bhith na fhacal. Pùt "feuch" gus fheuchainn.</p>\n      <p>Às dèidh gach tomhas, atharrachaidh dath an taidhle gus sealltain cho faisg agus a bha thu.</p>\n      <div class="examples">\n        <p><strong>Eiseimpleirean</strong></p>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="f" evaluation="correct" reveal></game-tile>\n            <game-tile letter="a"></game-tile>\n            <game-tile letter="c"></game-tile>\n            <game-tile letter="a"></game-tile>\n            <game-tile letter="l"></game-tile>\n          </div>\n          <p>Tha an lìtir <strong>F</strong> san fhacal, san àite cheart.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="t"></game-tile>\n            <game-tile letter="a" evaluation="present" reveal></game-tile>\n            <game-tile letter="i"></game-tile>\n            <game-tile letter="g"></game-tile>\n            <game-tile letter="h"></game-tile>\n          </div>\n          <p>Tha an litir <strong>a</strong> san fhacal, ach san àite cheàrr.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="s"></game-tile>\n            <game-tile letter="g"></game-tile>\n            <game-tile letter="ì"></game-tile>\n            <game-tile letter="t" evaluation="absent" reveal></game-tile>\n            <game-tile letter="h"></game-tile>\n          </div>\n          <p>Chan eil an lìtir <strong>T</strong> san fhacal idir.</p>\n        </div>\n      </div>\n      <p><strong>Bidh FACLE ùr ann gach latha!<strong></p>\n   </div>\n      </div>\n      <p><strong>Chaidh an geama seo a dhèanamh le Josh Wordle, agus is ann leis-san a tha gach ceart. Eadar-theangachadh le Gordon Maloney.<strong></p>\n  </div>\n  </section>\n';
    var Hs = (function (e) {
      r(t, e);
      var a = h(t);
      function t() {
